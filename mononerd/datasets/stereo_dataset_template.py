...
from mononerd.utils import common_utils, box_utils, depth_map_utils
...
from mononerd.utils.calibration_kitti import Calibration
...
class StereoDatasetTemplate(torch_data.Dataset):
    ...
    def prepare_data(self, data_dict):
        ...
        if 'points' in data_dict:
            ...
            data_dict['depth_gt_right_img'] = depth_map_utils.points_to_right_depth_map(rect_points, image_shape, data_dict['calib'])
